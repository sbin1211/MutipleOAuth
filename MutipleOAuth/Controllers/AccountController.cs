    ...
    public class AccountController : Controller
    {
        ...
        internal class ChallengeResult : HttpUnauthorizedResult
        {
            ...
            public override void ExecuteResult(ControllerContext context)
            {
                ...
                properties.Dictionary[MTenantConstants.AuthenticationTenantKey] = TenantKey;
                properties.Dictionary[MTenantConstants.AuthenticationProviderKey] = LoginProvider;
                if (UserId != null)
                {
